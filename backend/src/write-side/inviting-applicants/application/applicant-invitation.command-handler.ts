...
export namespace ApplicantInvitationCommandHandler {
    ...
    export class InviteApplicantToAssociation implements ICommandHandler<ApplicantInvitationCommand.InviteApplicantToAssociation> {
        ...
        async execute({firstName, lastName, personalEmail}: ApplicantInvitationCommand.InviteApplicantToAssociation): Promise<ApplicantInvitationId> {
    ...
    export class CancelApplicantInvitation implements ICommandHandler<ApplicantInvitationCommand.CancelApplicantInvitation> {
        ...
        async execute({applicantInvitationId}: ApplicantInvitationCommand.CancelApplicantInvitation) {
            return executeCommand(this.repository, ApplicantInvitationId.of(applicantInvitationId), invitation => invitation.cancel());
        }
