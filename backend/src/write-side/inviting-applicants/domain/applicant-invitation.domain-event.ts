...
export namespace ApplicantInvitationDomainEvent {
    ...
    type ApplicantInvitedPayload = { personalEmail: PersonalEmail; firstName: FirstName, lastName: LastName }

    export class ApplicantInvited extends AbstractApplicantInvitationDomainEvent<ApplicantInvitedPayload> {

        static newFrom(aggregateId: ApplicantInvitationId, occurredAt: Date, payload: ApplicantInvitedPayload) {
    ...
    export class InvitationCancelled extends AbstractApplicantInvitationDomainEvent<{}> {
        ...
        static newFrom(aggregateId: ApplicantInvitationId, occurredAt: Date, payload: {}) {
