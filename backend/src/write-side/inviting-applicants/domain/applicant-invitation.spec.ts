    ...
    describe("Scenario: Invite applicant for the first time", () => {
        ...
        describe("Given: An applicant to invite", () => {
            ...
            describe("When: Try to invite an applicant", () => {
                ...
                beforeEach(() => {
                    applicantInvitation.invite(applicantInvitationId, {...person.janKowalski})
                });

                it("Then: The applicant should be invited", () => {
                    expect(applicantInvitation.getUncommittedEvents().map(it => it.constructor)).toContain(ApplicantInvited)
                })
        ...
        describe("Given: An applicant which was invited", () => {
            ...
            describe("When: Try to invite an applicant", () => {
                ...
                it("Then: The applicant should not be invited", () => {
                    expect(() => applicantInvitation.invite(applicantInvitationId, {...person.janKowalski})).toThrow()
                })
        ...
        describe("Given: An applicant which was invited", () => {
            ...
            describe("When: Try to cancel invitation", () => {
                ...
                it("Then: The applicant invitation should be cancelled", () => {
                    expect(applicantInvitation.getUncommittedEvents().map(it => it.constructor)).toContain(InvitationCancelled)
                })
