...
const events = {
  aggregate1: {
    id: aggregate1id,
    eventStreamId: EventStreamName.from('aggregateType1', aggregate1id),
    event1: {
      eventId: uuid.v4(),
  ...
  aggregate2: {
    id: aggregate2id,
    eventStreamId: EventStreamName.from('aggregateType2', aggregate2id),
    event1: {
      eventId: uuid.v4(),
      eventType: 'EVENT_TYPE_1',
...
describe('Feature: Event Storage', () => {
  ...
  //TODO: TypeORM works only if is alone
  [
